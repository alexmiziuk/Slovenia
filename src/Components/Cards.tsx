...
const cardData = [
	...
	},
	{
		...
		text: 'Словенія не є ідеальним варіантом для іноземців, що шукають роботу, оскільки і місцевим мешканцям самим не легко знайти вигідні працевлаштування, а зарплати тут нижчі, ніж у Німеччині. Багато молодих словенців відїжджають працювати до Австрії та Німеччини, де є більше можливостей для розвитку. Словенія більше підходить для відпочинку та для бізнесменів з країна колишнього Радянського Союзу, де можна відкрити фірму порівнянно з невеликими витратами та отримати вид на життя. Однак, для карєрного зростання та високих зарплат, іноземцям краще розглянути інші європейські країни з більшими можливостями працевлаштування.',
		imageSrc: Work,
	},
	{
		id: 5,
